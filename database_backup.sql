...
-- ----------------------------
INSERT INTO `salereturndetail` (`ReturnDetailID`, `ReturnID`, `ProductID`, `Quantity`, `Price`, `Subtotal`) VALUES (1, 11, 5, 1, '3.98', '3.98');
INSERT INTO `salereturndetail` (`ReturnDetailID`, `ReturnID`, `ProductID`, `Quantity`, `Price`, `Subtotal`) VALUES (2, 12, 3, 1, '4.50', '4.50');
INSERT INTO `salereturndetail` (`ReturnDetailID`, `ReturnID`, `ProductID`, `Quantity`, `Price`, `Subtotal`) VALUES (3, 13, 3, 1, '4.50', '4.50');
INSERT INTO `salereturndetail` (`ReturnDetailID`, `ReturnID`, `ProductID`, `Quantity`, `Price`, `Subtotal`) VALUES (4, 14, 4, 1, '49.90', '49.90');
INSERT INTO `salereturndetail` (`ReturnDetailID`, `ReturnID`, `ProductID`, `Quantity`, `Price`, `Subtotal`) VALUES (5, 15, 3, 1, '4.50', '4.50');
INSERT INTO `salereturndetail` (`ReturnDetailID`, `ReturnID`, `ProductID`, `Quantity`, `Price`, `Subtotal`) VALUES (6, 16, 4, 2, '49.90', '99.80');
INSERT INTO `salereturndetail` (`ReturnDetailID`, `ReturnID`, `ProductID`, `Quantity`, `Price`, `Subtotal`) VALUES (7, 16, 5, 1, '3.98', '3.98');
INSERT INTO `salereturndetail` (`ReturnDetailID`, `ReturnID`, `ProductID`, `Quantity`, `Price`, `Subtotal`) VALUES (8, 17, 3, 1, '4.50', '4.50');
INSERT INTO `salereturndetail` (`ReturnDetailID`, `ReturnID`, `ProductID`, `Quantity`, `Price`, `Subtotal`) VALUES (9, 18, 5, 1, '3.98', '3.98');
...
-- ----------------------------
-- 表结构: userpermissionsview
-- ----------------------------
DROP TABLE IF EXISTS `userpermissionsview`;
...
INSERT INTO `users` (`UserID`, `Username`, `Password`, `Role`, `CreatedAt`, `LastLogin`, `Status`, `Email`, `FullName`, `PhoneNumber`) VALUES (5, 'cashier1', 'cashier123', '', '2025-06-02 16:15:03', '2025-06-02 19:55:09', 1, 'cashier1@supermarket.com', '收银员', '222222');
