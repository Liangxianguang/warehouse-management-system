...
-- 插入销售数据
INSERT INTO Sale (ProductID, CustomerID, EmployeeID, Quantity, SalePrice, TotalAmount, SaleDate) VALUES
(1, 1, 2, 2, 59.90, 119.80, '2024-01-15 09:30:00'),
(2, 3, 2, 5, 8.90, 44.50, '2024-01-15 10:15:00'),
(3, 2, 4, 10, 4.50, 45.00, '2024-01-15 14:20:00'),
(4, 4, 4, 1, 49.90, 49.90, '2024-01-15 16:45:00');

-- 插入销售退货数据
INSERT INTO SaleReturn (SaleID, Quantity, ReturnDate, Reason) VALUES
(3, 2, '2024-01-16 10:00:00', '包装破损'),
(1, 1, '2024-01-16 11:30:00', '质量问题');
...
-- 插入用户数据
INSERT INTO Users (Username, Password, Role, CreatedAt, LastLogin, Status) VALUES
('admin', 'admin123', 'admin', '2024-12-20 22:03:05', NULL, 1),
('warehouse', 'wh123', 'warehouse', '2024-12-20 22:03:05', NULL, 1),
('sales', 'sales123', 'sales', '2024-12-20 22:03:05', NULL, 1);

-- 插入批次库存测试数据
INSERT INTO BatchStock (ProductID, BatchNo, InboundDate, Quantity, RemainingQuantity, Location) VALUES
(1, 'BATCH001', NOW(), 100, 100, 'A-01-01'),
(2, 'BATCH002', NOW(), 50, 50, 'A-02-01'),
(3, 'BATCH003', NOW(), 200, 200, 'B-01-01'),
(4, 'BATCH004', NOW(), 80, 80, 'B-02-01'),
(5, 'BATCH005', NOW(), 30, 30, 'C-01-01');